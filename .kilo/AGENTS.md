...
> **Redirect to canonical file.** The tool-agnostic, canonical AI instructions for this repository live at the repository root in `AGENTS.md`. This file is kept only as a Kilo-specific load path; its content is maintained in lockstep with `AGENTS.md`.
>
> For tool compatibility notes and loading strategies, see `docs/AI Instructions.md`.

---

# Canonical Source

Please read `AGENTS.md` at the repository root. Everything below this line is a historical mirror that is no longer the source of truth.
