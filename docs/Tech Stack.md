...
| Lint / Format  | Biome                              | Fast all-in-one linter and formatter                      |
...
- **Biome**: Replaced ESLint and Prettier with Biome (`@biomejs/biome` 2.5.12). Unified linter and formatter, faster CI checks, zero config drift, and native Tailwind CSS v4 directive support.
